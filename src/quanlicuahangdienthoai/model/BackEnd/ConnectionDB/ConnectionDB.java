package quanlicuahangdienthoai.model.BackEnd.ConnectionDB;
...
public class ConnectionDB {
    ...
    private void setupConnect() {
        try {
            ...
            System.err.println(e+"hello");
            System.err.println("-- ERROR! Khong thể kết nối tới '" + DB_Name + "'");
            JOptionPane.showMessageDialog(null, "-- ERROR! Khong thể kết nối tới '" + DB_Name + "'");
        }
    }
    ...
    public void closeConnect() {
        try {
            ...
            System.out.println("Success! Đóng kết noi tới '" + DB_Name + "' thành công.\n**");
        } catch (SQLException ex) {
    ...
    public Boolean checkConnect() {
        if (conn == null || stmt == null) {
            JOptionPane.showMessageDialog(null, "-- ERROR! Chưa1 thiết lập kết nối tới '" + DB_Name + "'. Vui lòng đăng nhập để thiết lập kết nối!");
            return false;
        }
        return true;
    }
