...
import static quanlicuahangdienthoai.MainPage.BHTTTable;
...
public class ChonKMForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SubKMTable.setBackground(new java.awt.Color(255, 255, 255));
        SubKMTable.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        SubKMTable.setForeground(new java.awt.Color(0, 0, 0));
        ...
        SubKMTable.setIntercellSpacing(new java.awt.Dimension(0, 0));
        ...
        SubKMTable.setShowVerticalLines(false);
        ...
        if (SubKMTable.getColumnModel().getColumnCount() > 0) {
            SubKMTable.getColumnModel().getColumn(0).setMaxWidth(70);
            SubKMTable.getColumnModel().getColumn(1).setPreferredWidth(1);
            SubKMTable.getColumnModel().getColumn(2).setPreferredWidth(1);
        }
