...
public class ChonMaQuyenForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SubQuyenTable.setBackground(new java.awt.Color(255, 255, 255));
        SubQuyenTable.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        SubQuyenTable.setForeground(new java.awt.Color(0, 0, 0));
        ...
        SubQuyenTable.setIntercellSpacing(new java.awt.Dimension(0, 0));
        ...
        SubQuyenTable.setShowVerticalLines(false);
        ...
        if (SubQuyenTable.getColumnModel().getColumnCount() > 0) {
            SubQuyenTable.getColumnModel().getColumn(0).setMaxWidth(70);
            SubQuyenTable.getColumnModel().getColumn(1).setPreferredWidth(1);
            SubQuyenTable.getColumnModel().getColumn(2).setPreferredWidth(1);
        }
