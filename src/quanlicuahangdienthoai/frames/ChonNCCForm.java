...
public class ChonNCCForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SubNCCTable.setBackground(new java.awt.Color(255, 255, 255));
        SubNCCTable.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        SubNCCTable.setForeground(new java.awt.Color(0, 0, 0));
        ...
        SubNCCTable.setIntercellSpacing(new java.awt.Dimension(0, 0));
        ...
        SubNCCTable.setShowVerticalLines(false);
        ...
        if (SubNCCTable.getColumnModel().getColumnCount() > 0) {
            SubNCCTable.getColumnModel().getColumn(0).setMaxWidth(70);
            SubNCCTable.getColumnModel().getColumn(1).setPreferredWidth(1);
            SubNCCTable.getColumnModel().getColumn(2).setPreferredWidth(1);
        }
    ...
    private void FilterSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_FilterSearchKeyReleased
        ...
        MainPage.filterTable(SubNCCTable, query, SearchType.getSelectedIndex()-1);
