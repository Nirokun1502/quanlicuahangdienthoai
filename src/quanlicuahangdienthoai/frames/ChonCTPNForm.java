...
import quanlicuahangdienthoai.model.FrontEnd.FormHienThi.HienThiChiTietPN;
import quanlicuahangdienthoai.model.FrontEnd.FormHienThi.HienThiLoaiSanPham;

public class ChonCTPNForm extends javax.swing.JFrame {
    
    
    public ChonCTPNForm(String mapn) {
        initComponents();       
        MainPage.Tabledesign(CTPNTable);
        MainPage.setTableCellAlignment(JLabel.CENTER, CTPNTable);
        QuanLyChiTietPhieuNhapBUS dsctpnBUS = new QuanLyChiTietPhieuNhapBUS();
        HienThiChiTietPN.AddTable(dsctpnBUS.search("Mã phiếu nhập",mapn),CTPNTable);
    ...
    private void initComponents() {
        ...
        CTPNTable.setAutoCreateRowSorter(true);
        CTPNTable.setBackground(new java.awt.Color(255, 255, 255));
        CTPNTable.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        CTPNTable.setForeground(new java.awt.Color(0, 0, 0));
        CTPNTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "STT", "Mã phiếu nhập", "Mã sản phẩm", "Tên sản phẩm", "Số lượng", "Đơn giá", "Thành tiền"
            }
        ) {
        ...
        CTPNTable.setGridColor(new java.awt.Color(128, 128, 128));
        CTPNTable.setIntercellSpacing(new java.awt.Dimension(0, 0));
        CTPNTable.setRowHeight(25);
        CTPNTable.setSelectionBackground(new java.awt.Color(122, 72, 221));
        CTPNTable.setSelectionForeground(new java.awt.Color(255, 255, 255));
        CTPNTable.setShowVerticalLines(false);
        ...
        if (CTPNTable.getColumnModel().getColumnCount() > 0) {
            CTPNTable.getColumnModel().getColumn(0).setMaxWidth(70);
    ...
    private void FilterSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_FilterSearchKeyReleased
        ...
        MainPage.filterTable(CTPNTable, query, SearchType.getSelectedIndex()-1);
...
//                new ChonCTHDForm(mahd).setVisible(true);
    ...
    public static javax.swing.JTable CTPNTable;
