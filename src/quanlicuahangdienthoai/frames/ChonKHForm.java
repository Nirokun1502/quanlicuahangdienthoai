...
public class ChonKHForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SubKHTable.setBackground(new java.awt.Color(255, 255, 255));
        SubKHTable.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        SubKHTable.setForeground(new java.awt.Color(0, 0, 0));
        ...
        SubKHTable.setIntercellSpacing(new java.awt.Dimension(0, 0));
        ...
        SubKHTable.setShowVerticalLines(false);
        SubKHTable.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(SubKHTable);
        if (SubKHTable.getColumnModel().getColumnCount() > 0) {
            SubKHTable.getColumnModel().getColumn(0).setMaxWidth(70);
            SubKHTable.getColumnModel().getColumn(1).setPreferredWidth(1);
            SubKHTable.getColumnModel().getColumn(2).setPreferredWidth(1);
        }
        ...
        SearchType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Mã khách hàng", "Tên khách hàng", "Địa chỉ", "Số điện thoại", "Trạng thái" }));
    ...
    private void FilterSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_FilterSearchKeyReleased
        ...
        MainPage.filterTable(SubKHTable, query, SearchType.getSelectedIndex()-1);
