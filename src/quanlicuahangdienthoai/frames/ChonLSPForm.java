...
public class ChonLSPForm extends javax.swing.JFrame {
    
    
    public ChonLSPForm() {
        initComponents();       
        MainPage.Tabledesign(SubLSPTable);
        QuanLyLoaiSanPhamBUS dslspBUS = new QuanLyLoaiSanPhamBUS();
        HienThiLoaiSanPham.AddTable(dslspBUS.getDslsp(),SubLSPTable);
        MainPage.setTableCellAlignment(JLabel.CENTER, SubLSPTable);
    ...
    private void initComponents() {
        ...
        SubLSPTable = new javax.swing.JTable();
        ...
        SubLSPTable.setAutoCreateRowSorter(true);
        SubLSPTable.setBackground(new java.awt.Color(255, 255, 255));
        SubLSPTable.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        SubLSPTable.setForeground(new java.awt.Color(0, 0, 0));
        SubLSPTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        SubLSPTable.setFocusable(false);
        SubLSPTable.setGridColor(new java.awt.Color(128, 128, 128));
        SubLSPTable.setIntercellSpacing(new java.awt.Dimension(0, 0));
        SubLSPTable.setRowHeight(25);
        SubLSPTable.setSelectionBackground(new java.awt.Color(122, 72, 221));
        SubLSPTable.setSelectionForeground(new java.awt.Color(255, 255, 255));
        SubLSPTable.setShowVerticalLines(false);
        SubLSPTable.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(SubLSPTable);
        if (SubLSPTable.getColumnModel().getColumnCount() > 0) {
            SubLSPTable.getColumnModel().getColumn(0).setMaxWidth(70);
            SubLSPTable.getColumnModel().getColumn(1).setPreferredWidth(1);
            SubLSPTable.getColumnModel().getColumn(2).setPreferredWidth(1);
        }
    ...
    private void FilterSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_FilterSearchKeyReleased
        ...
        MainPage.filterTable(SubLSPTable, query, SearchType.getSelectedIndex()-1);
    ...
    public static javax.swing.JTable SubLSPTable;
